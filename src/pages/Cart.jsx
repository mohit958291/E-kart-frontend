    ...
    
    {
                ...
                return <Card key={index}>
                  <div className="flex justify-between items-center pr-7">
                    <div className="flex items-center w-[350px]">
                      <img src={product?.productId?.productImg?.[0]?.url || userLogo} alt="" 
                      className='w-25 h-25'/>
      ...
      <div className='flex flex-col items-center justify-center min-h-[60vh] p-6 text-center'>
        ...
        <div className="bg-pink-100 p-6 rounded-full">
          <ShoppingCart className='w-16 text-pink-600'/>
        </div>
        {/* title */}
        <h2 className='mt-6 text-2xl font-bold text-gray-800'>Your Cart is Empty</h2>
        <p className='mt-2 text-gray-6000'>Looks like you haven't added anything to your cart yet</p>
