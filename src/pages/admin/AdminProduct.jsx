...
if(sortOrder === 'highTolow'){
  ...
  const formData = new FormData()
    ...
    formData.append("productDesc",editProduct.productDecs);
    ...
    const exisitingImages = editProduct.productImg.filter((img)=> !(img instanceof File)&&
     img.public_id)
        ...
        <DialogContent className="sm:max-w-[625px] max-h-[740px] overflow-y-scroll">
         ...
         <div className="flex flex-col gap-2">
            ...
            <div className="grid gap-2">
              ...
              <Textarea 
               value={editProduct?.productDecs}
              onChange={handleChange}
              name="productDesc" placeholder="Enter brief description of product"/>
            </div>
