...
function FilterSidebar({search,setSearch, category,setCategory,brand, setBrand, setPriceRange, allProducts,priceRange}) {
  ...
  return (
    <div>
        <div className="bg-gray-100 mt-10 p-4 rounded-md h-max hidden md:block w-71">
            {/* Search */}
            <Input type="text"
             placeholder='Search...'
             value={search}
           ...
           <select className='bg-white w-full p-2 border-gray-200 border-2 rounded-md' name="" value={brand} onChange={handleBrandChange} id="">
            {
